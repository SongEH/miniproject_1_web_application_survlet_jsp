			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<table class="table">
						...
						<tr>
							<th>구분</th>
							<td><input type="radio" id="p_type_1" name="p_type"
								value="1" checked> <label for="normal">일반</label> <input
								type="radio" id="p_type_2" name="p_type" value="2"> <label
								for="notice">공지</label></td>
						</tr>
						</c:if>
						<tr>
